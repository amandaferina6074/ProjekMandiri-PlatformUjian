        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                ...
                <form action="{{ route('soal.update', $soal) }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- KEMBALIKAN DIV UNTUK INPUT GAMBAR --}}
                    <div class="mb-4">
                        ...
                        @if ($soal->image_path)
                            {{-- PERUBAHAN: Gunakan Storage::url() --}}
                            <small class="text-muted mt-1 d-block">Gambar saat ini: <img src="{{ Storage::url($soal->image_path) }}" alt="Gambar Saat Ini" class="img-thumbnail" style="max-height: 100px;"></small>
