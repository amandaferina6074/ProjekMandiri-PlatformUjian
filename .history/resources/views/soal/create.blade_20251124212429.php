...
<body>
    ...
    <main class="container my-5">
        <div class="row justify-content-center">
            {{-- Mengubah nilai inisial Alpine: 'pg' menjadi 'pilihan_ganda' --}}
            <div class="col-lg-8" x-data="{ type: '{{ old('type', 'pilihan_ganda') }}' }">
                    ...
                    <form action="{{ route('soal.store', $ujian) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="type" name="type" x-model="type">
                                {{-- Menggunakan nilai 'pilihan_ganda' yang konsisten dengan Controller --}}
                        ...
                        <div x-show="type === 'pilihan_ganda'" x-transition.duration.500ms>
                            ...
                            <div class="input-group option-group mb-3">
                                ...
                                <input type="text" 
                                        ...
                                        value="{{ old('pilihan.'.$i) }}"
                                        x-bind:required="type === 'pilihan_ganda'">
                                @error('pilihan.'.$i) <div class="text-danger small ms-2">{{ $message }}</div> @enderror
                            </div>
                            @endfor
