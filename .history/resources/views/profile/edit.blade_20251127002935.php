...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Form Styling Override (Karena partials bawaan Breeze pakai Tailwind) */
    ...
    <main class="container my-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                {{-- 3. Delete Account --}}
                <div class="card fade-in-up border-danger">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning border-0 bg-warning-subtle text-warning-emphasis">
                            <strong>Perhatian:</strong> Tindakan ini tidak dapat dibatalkan. Semua data akan hilang permanen.
                        </div>
