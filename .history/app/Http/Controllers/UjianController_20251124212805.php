...
class UjianController extends Controller
{
    ...
    public function storeSoal(Request $request, Ujian $ujian)
    {
        ...
        // Nilai validasi disesuaikan dengan nilai yang dikirim Blade: 'pilihan_ganda' atau 'esai'
        $request->validate([
            ...
            'pilihan' => 'required_if:type,pilihan_ganda|array|min:2', 
            'pilihan.*' => 'required_if:type,pilihan_ganda|string|max:255',
            'jawaban_benar' => 'required_if:type,pilihan_ganda|integer|min:0', 
        ]);
