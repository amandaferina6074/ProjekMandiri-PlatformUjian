...
class UjianController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->role === 'dosen') {
            ...
            // DOSEN → DAFTAR UJIAN YANG DIA BUAT
            ...
            // MAHASISWA → RIWAYAT UJIAN YANG PERNAH DIA IKUTI
    ...
    public function searchByToken(Request $request)
    {
        ...
        // Redirect ke halaman konfirmasi mulai ujian
